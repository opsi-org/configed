...
// works on a map of pairs of type String - List
{
		...
		boolean reloadable)
	{
		...
		logging.info(this, "DefaultEditMapPanel " +  keylistExtendible + ",  " +  keylistEditable + ",  " + reloadable);
	}
	...
	*/
	...
	public void setEditableMap(Map<String, Object> visualdata, Map<String, ListCellOptions> optionsMap)
	{
		...
		if (optionsMap == null)
		{
			...
			// we introduce an empty Map since otherwise we use two cell editors, and they dont come always when they should
		}
		else
		{
