...
public class TableCellRendererByIndex extends StandardTableCellRenderer
{
	...
	public TableCellRendererByIndex(Map<String,String> mapOfStringValues, String imagesBase, boolean showOnlyIcon, String tooltipPrefix)
	{
		super(tooltipPrefix);
	...
	*/
		...
		int column)
	{
		...
		if (value != null) 
		{
			...
			//logging.debug(this, " :1 value is " + value + " value class is " + value.getClass());
			if (mapOfStrings != null) selectedString = mapOfStrings.get("" + value);
			//logging.debug(this, " :1 selectedString is " + selectedString);
			//logging.debug(this, " :2 value is " + value + " value class is " + value.getClass());
		...
		if (result instanceof JLabel) {
			...
			((JLabel)result).setToolTipText(Globals.fillStringToLength(tooltipPrefix + " "+selectedString + " ", FILL_LENGTH)) ;
