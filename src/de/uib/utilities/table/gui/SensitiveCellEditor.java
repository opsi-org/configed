	...
	implements TableCellEditor, MouseListener
{
	...
	public static synchronized SensitiveCellEditor getInstance(Object key) {
            ...
            if (instance == null) {
                ...
                instance.myKey = "" + key;
                logging.info(instance.getClass().getName() + " produced instance for key " + key + " ; size of instances " + instances.size());
            }
 			return instance;
    	}
	...
	private void startListEditor(final JTable table, final int row,  final int column)
	{
		...
		SwingUtilities.invokeLater(new Runnable(){
				public void run(){
					...
					listeditor.centerOn( de.uib.configed.Globals.mainContainer );
