...
public class OpsiserviceSQLgetrowsPersistenceController extends OpsiserviceNOMPersistenceController
{
	
	java.sql.Time PRODUCT_ON_CLIENT_last_read = null;
	
	OpsiserviceSQLgetrowsPersistenceController (String server, String user, String password)
	{
	...
	protected  Map<String, java.util.List<Map<String, String>>> getLocalBootProductStatesNOM(String[] clientIds)
	{
		...
		java.util.List<java.util.List<java.lang.String>> 
			...
			for (java.util.List<String> row : productOnClients)
			{
				...
				for (int i = 0; i < ProductState.DB_COLUMN_NAMES.size(); i++)
				{
					rowMap.put(ProductState.DB_COLUMN_NAMES.get(i), row.get(i+1));
				}
