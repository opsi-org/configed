...
public abstract class JSONExecutioner extends Executioner
{
	...
	public JSONObject jsonMap (Map m)
	{
	...
	public Object jsonArray(List l)
	{
		Object result = null;
		...
		try
		{
			if (jO != null)
			{
				...
				while (iter.hasNext())
				{
					...
					//logging.debug(this, "getMapOfLists, key " + key  + " list value " + JSONReMapper.getJsonList(jOResult, key));
	...
	/*
	public Map<String, Map<String, Map<String, Object>>> getMap3_Object(Object retrieved)
	 {
	...
	public Map<String, Object> getMapFromItem (Object s)
	{
		...
		try
		{
			...
			if (!wehavejO || jO == JSONObject.NULL)
			{
				...
				{
					logging.debugOut ("JSONExecutioner.getMapFromItem",
					                  logging.LEVEL_INFO,  " \"" + s + "\" is  JSONObject.NULL and cannot be cast to a JSON Object");
				}
				...
				else
				{
					...
					logging.debugOut ("JSONExecutioner.getMapFromItem",
					                  logging.LEVEL_INFO,  " \"" + s + "\" has class " + s.getClass().getName() + " cannot be cast to a JSON Object");
				}
			}
		}
		catch (Exception ex)
