		...
		implements NameProducer
{
			...
			else
			{
				...
				if ( opsiPackageOnWorkbench.exists() )
				{
					...
					returnedOption = JOptionPane.showOptionDialog(rootFrame,	
										...
										Globals.APPNAME + " " + configed.getResourceValue("InstallOpsiPackage.packageReinstallTitle"),
					...
					//it is not there and we have to copy it
				{
					...
					logging.debug(this, "getProductToWorkbench copy " + opsiPackagePathToHandle + ", " + opsiWorkBenchDirectory);
	...
	private void defineChoosers()
	{
		...
		chooserServerpath.setDialogTitle(Globals.APPNAME + " " +configed.getResourceValue("InstallOpsiPackage.chooserServerPath"));
	...
	private void initComponents()
	{
		...
		//workbench =  "\\\\" + comboChooseDepot.getSelectedItem() + "\\" +  packageShareS;
		...
		buttonMountShare.setToolTipText(configed.getResourceValue("InstallOpsiPackage.mountShareDescription")) ;
		...
		*/
		...
		buttonCallExecute.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent e)
				{
					...
					logging.info(this, "actionPerformed on buttonCallExecute opsiPackageGotPathS,  depot:  " + fieldOpsiPackageName.getText() + ", " + comboChooseDepot.getSelectedItem());
	...
	public void defineLayout()
	{
		...
		//JLabel tmpdirLabel = new JLabel( configed.getResourceValue("InstallOpsiPackage.tmpDir") );
		//mountShareLabel = new JLabel( configed.getResourceValue("InstallOpsiPackage.mountShare" ) );
		//mountShareLabel = new JLabel("");
		//mountShareDescriptionLabel = new JLabel( configed.getResourceValue("InstallOpsiPackage.mountShareResult0" ) );
		...
		layout.setVerticalGroup(layout.createSequentialGroup()
			...
			.addGroup( layout.createParallelGroup(GroupLayout.Alignment.CENTER) 
				...
				.addComponent(buttonCallChooserPackage, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
			...
			.addGroup( layout.createParallelGroup(GroupLayout.Alignment.CENTER) 
				...
				//.addComponent(fieldDepotName, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				)
			...
			.addGroup( layout.createParallelGroup(GroupLayout.Alignment.CENTER) 
				...
				.addComponent(buttonCallChooserServerpath, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
			...
			.addGap(Globals.vGapSize/2, Globals.vGapSize/2, Globals.vGapSize/2)
			.addGroup( layout.createParallelGroup(GroupLayout.Alignment.CENTER) 
				.addComponent(tmpdirLabel, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				.addComponent(buttonSelectTmpDir, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				.addComponent(fieldTmpDir, Globals.lineHeight,  Globals.lineHeight, Globals.lineHeight)
				//.addComponent(fieldDepotName, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				)
			*/
			.addGap(Globals.vGapSize, Globals.vGapSize, Globals.vGapSize)
		...
		layout.setHorizontalGroup(layout.createParallelGroup()
			...
			.addGroup(layout.createSequentialGroup()
				...
				.addComponent(buttonCallChooserPackage, GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE)
				.addGap(hFirstGap, hFirstGap, hFirstGap)
				.addComponent(fieldOpsiPackageName, Globals.buttonWidth *2 ,  Globals.buttonWidth*2,  Short.MAX_VALUE)
			...
			.addGroup(layout.createSequentialGroup()
				...
				//.addComponent(fieldDepotName, GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE,  Short.MAX_VALUE)
				.addGap(Globals.hGapSize, Globals.hGapSize*3,  Short.MAX_VALUE)
			)
			...
			.addGroup(layout.createSequentialGroup()
				...
				.addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize ) 
				.addComponent(buttonCallChooserServerpath, GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE)
				.addGap(hFirstGap, hFirstGap, hFirstGap)
				.addComponent(fieldServerPath, Globals.buttonWidth *2 ,  Globals.buttonWidth*2,  Short.MAX_VALUE)
				.addGap(5, 5, 5)
				.addGap(Globals.hGapSize, Globals.hGapSize*3,  Short.MAX_VALUE)
				)
			/*
			.addGroup(layout.createSequentialGroup()
				...
				.addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
				.addComponent(buttonSelectTmpDir,Globals.graphicButtonWidth, Globals.graphicButtonWidth,  Globals.graphicButtonWidth)
				.addGap(hFirstGap, hFirstGap, hFirstGap)
				.addComponent(fieldTmpDir, Globals.buttonWidth *2 ,  Globals.buttonWidth*2,    Short.MAX_VALUE)
				//.addComponent(fieldDepotName, GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE,  Short.MAX_VALUE)
				.addGap(Globals.hGapSize, Globals.hGapSize*3,  Short.MAX_VALUE)
			)
			*/
