		...
		
{
	...
	{
		logging.info(this, "produceName ? fieldTargetPath , depotProductDirectory " + fieldTargetPath+ " , " + depotProductDirectory);
		if (fieldTargetPath == null || fieldTargetPath.getText().equals("") ||fieldTargetPath.getText().startsWith(depotProductDirectory))
	...
	private void initComponents()
	{
		...
		buttonCallSelectFolderInstallFiles.setToolTipText(configed.getResourceValue("CompleteWinProducts.chooserFolderInstallFiles")) ;
		...
		buttonCallExecute.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent e)
				{
					logging.debug(this, "actionPerformed on buttonCallExecute pathWinPE, pathInstallFiles, productKey, winproduct " 
								+ fieldPathWinPE.getText()  + ", " + fieldPathInstallFiles.getText() + ", " + fieldProductKey.getText() + ", " +  comboChooseWinProduct.getSelectedItem());
	...
	{	
		...
		try{
			...
			{
				targetDirectory = new File( fieldTargetPath.getText() + File.separator  + SmbConnect.directoryInstallFiles );
				FileUtils.copyDirectory(new File(pathInstallFiles), targetDirectory);
			}
				
			persist.setRights( "/" + SmbConnect.unixPath(SmbConnect.directoryProducts) + "/" + winProduct + "/" + SmbConnect.directoryPE )  ;
			persist.setRights( "/" + SmbConnect.unixPath(de.uib.connectx.SmbConnect.directoryProducts) + "/" + winProduct + "/" + SmbConnect.directoryInstallFiles );
			waitCursor.stop();
			...
			if ( !oldProductKey.equals( productKey ))
			{
				...
				returnedOption = JOptionPane.showOptionDialog( rootFrame,
									configed.getResourceValue("PanelCompleteWinProducts.setChangedProductKey"),
	...
	public void defineLayout()
	{
		...
		JLabel labelFolderInstallFiles = new JLabel(configed.getResourceValue("CompleteWinProducts.labelFolderInstallFiles"));
		...
		layout.setVerticalGroup(layout.createSequentialGroup()
			...
			.addGroup( layout.createParallelGroup(GroupLayout.Alignment.CENTER)
				...
				.addComponent(comboChooseWinProduct, Globals.lineHeight,   Globals.lineHeight, Globals.lineHeight)
				)
			.addGap(Globals.vGapSize/2, Globals.vGapSize/2, Globals.vGapSize/2)
			.addGroup( layout.createParallelGroup(GroupLayout.Alignment.CENTER) 
				.addComponent(labelFolderWinPE, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				.addComponent(buttonCallSelectFolderWinPE, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				.addComponent(fieldPathWinPE, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				)
			.addGap(Globals.vGapSize/2, Globals.vGapSize/2, Globals.vGapSize/2)
			.addGroup( layout.createParallelGroup(GroupLayout.Alignment.CENTER) 
				.addComponent(labelFolderInstallFiles, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				.addComponent(buttonCallSelectFolderInstallFiles, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				.addComponent(fieldPathInstallFiles, Globals.lineHeight, Globals.lineHeight, Globals.lineHeight)
				)
		...
		layout.setHorizontalGroup(layout.createParallelGroup()
			...
			.addGroup(layout.createSequentialGroup()
				...
				.addGap(hFirstGap, hFirstGap, hFirstGap)
				.addComponent(comboChooseDepot, Globals.buttonWidth *2 ,  Globals.buttonWidth*2, Globals.buttonWidth*2)
			...
			.addGroup(layout.createSequentialGroup()
				...
				.addGap(Globals.graphicButtonWidth, Globals.graphicButtonWidth,  Globals.graphicButtonWidth)
				.addGap(hFirstGap, hFirstGap, hFirstGap)
				.addComponent(comboChooseWinProduct, Globals.buttonWidth *2 ,  Globals.buttonWidth*2, Globals.buttonWidth*2)
				.addGap(Globals.hGapSize, Globals.hGapSize*3,  Short.MAX_VALUE)
				)
			...
			.addGroup(layout.createSequentialGroup()
				...
				.addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
				.addComponent(buttonCallSelectFolderWinPE,Globals.graphicButtonWidth, Globals.graphicButtonWidth,  Globals.graphicButtonWidth)
				.addGap(hFirstGap, hFirstGap, hFirstGap)
			...
			.addGroup(layout.createSequentialGroup()
				...
				.addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
				.addComponent(buttonCallSelectFolderInstallFiles,Globals.graphicButtonWidth, Globals.graphicButtonWidth,  Globals.graphicButtonWidth)
				.addGap(hFirstGap, hFirstGap, hFirstGap)
				.addComponent(fieldPathInstallFiles, Globals.buttonWidth *2 ,  Globals.buttonWidth*2,    Short.MAX_VALUE)
				.addGap(Globals.hGapSize, Globals.hGapSize*3,  Short.MAX_VALUE)
			)
			.addGroup(layout.createSequentialGroup()
			...
			.addGroup(layout.createSequentialGroup()
				...
				.addGap(Globals.graphicButtonWidth, Globals.graphicButtonWidth,  Globals.graphicButtonWidth)
				.addGap(hFirstGap, hFirstGap, hFirstGap)
				.addComponent(fieldTargetPath, Globals.buttonWidth *2 ,  Globals.buttonWidth*2, Short.MAX_VALUE)
				.addGap(Globals.hGapSize, Globals.hGapSize*3,  Short.MAX_VALUE)
				)
			.addGroup(layout.createSequentialGroup()
				.addGap(hFirstGap, hFirstGap,  hFirstGap)
				...
				.addGap(Globals.graphicButtonWidth, Globals.graphicButtonWidth,  Globals.graphicButtonWidth)
				.addGap(hFirstGap, hFirstGap, hFirstGap)
				.addComponent(fieldProductKey, Globals.buttonWidth *2 ,  Globals.buttonWidth*2, Globals.buttonWidth*2)
				.addGap(Globals.hGapSize, Globals.hGapSize*3,  Short.MAX_VALUE)
				)
			.addGroup(layout.createSequentialGroup()
				.addGap(hFirstGap, hFirstGap, hFirstGap)
				...
				.addComponent(buttonCallExecute,  GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE)
