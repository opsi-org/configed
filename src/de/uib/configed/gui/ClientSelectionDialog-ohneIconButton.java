...
public class ClientSelectionDialog extends FGeneralDialog
{
    ...
    private void init()
    {
        ...
        savedSearchBox.setMaximumSize( new Dimension( savedSearchBox.getMaximumSize().width, savedSearchBox.getPreferredSize().height ) );
        ...
        savedVGroup.addComponent( savedSearchBox, GroupLayout.Alignment.CENTER );
    ...
    private SimpleGroup createSimpleGroup( SelectElement element, boolean toHostGroup )
    {
        ...
        result.negateButton = new JToggleButton("NOT");
        result.negateButton.setForeground( deselectedColor );
    ...
    private class SimpleGroup
    {
        ...
        public JToggleButton negateButton;
    ...
    private class NotButtonListener implements ActionListener
    {
        public void actionPerformed( ActionEvent event )
        {
            ...
            if( button.isSelected() )
                ...
                button.setForeground( deselectedColor );
        }
    }
