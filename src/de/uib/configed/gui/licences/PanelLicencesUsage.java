			...
			implements ActionListener
{
	...
	private void initSubPanel(){
		...
		labelGetAndAssignSL = new javax.swing.JLabel(configed.getResourceValue("ConfigedMain.Licences.Usage.LabelAssignLicense"));
		...
		panelGetAndAssignSLLayout.setHorizontalGroup(
		    ...
		    .addGroup(panelGetAndAssignSLLayout.createSequentialGroup()
		              .addGap(20, 20, 20)
		              .addGroup(panelGetAndAssignSLLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
		                        .addGroup(panelGetAndAssignSLLayout.createSequentialGroup()
		                                  .addComponent(labelGetAndAssignSL)
		                                  .addGap(20, 20, 20)
		                                  .addComponent(comboClient, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)
		                                 )
		                        .addComponent(panelLicencepools, javax.swing.GroupLayout.Alignment.TRAILING, 20, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		panelGetAndAssignSLLayout.setVerticalGroup(
		    ...
		    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelGetAndAssignSLLayout.createSequentialGroup()
		              .addGap(5, 5, 5)
		              .addGroup(panelGetAndAssignSLLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
		                        .addComponent(labelGetAndAssignSL, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
		                        .addComponent(comboClient, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
		                       )
		              .addGap(5, 5, 5)
	...
	private void initComponents() {
		...
		//panelKeys = new PanelGenEditTable(configed.getResourceValue("ConfigedMain.Licences.SectiontitleLicenceUsable"),
		//	0, false, 0);

		//panelWindowsSoftwareIds = new PanelGenEditTable(configed.getResourceValue("ConfigedMain.Licences.SectiontitleWindowsSoftwareIDs"),
		//	0, false, -1);
		...
		.addComponent(panelUsage, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		...
		//.addComponent(panelWindowsSoftwareIds, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		.addComponent(panelGetAndAssignSL, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
		              )
		          .addContainerGap())
		  );
		  layout.setVerticalGroup(
		...
		//.addComponent(testfield, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE)
		          .addComponent(panelUsage, minVSize,  javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
		          .addGap(Globals.vGapSize, Globals.vGapSize, Globals.vGapSize)
		//.addComponent(panelKeys, minVSize, javax.swing.GroupLayout.DEFAULT_SIZE, 150)
		//.addComponent(panelWindowsSoftwareIds, minVSize, javax.swing.GroupLayout.DEFAULT_SIZE, 120)
		.addComponent(panelGetAndAssignSL, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE, 150)
		.addGap(Globals.vGapSize, Globals.vGapSize, Globals.vGapSize)
		)
