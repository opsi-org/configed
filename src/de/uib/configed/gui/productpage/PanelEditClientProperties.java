...
public class PanelEditClientProperties extends DefaultPanelEditProperties
{
	...
	protected void initComponents()
	{
		...
		buttonSetValuesFromServerDefaults.addActionListener(new ActionListener(){
				public void actionPerformed(ActionEvent e)
				{
					...
					/*  // test
					System.out.println(" action performed on buttonSetValuesFromServerDefaults ");
	...
	{
		super.setSpecificPropertiesExisting(productName, specificPropertiesExisting);
	...
	{
		super.setPropertyResetActivated(b);
