...
public class SSHCommandControlDialog extends FGeneralDialog
{
	...
	*  @param owner Usually the MainFrame
	...
	{
		super(null,configed.getResourceValue("MainFrame.jMenuSSHCommandControl"), null);
		...
		parameterPanel = new SSHCommandControlParameterMethodsPanel(this, 
			Globals.gapSize*3,Globals.gapSize*3, Globals.gapSize*2, 0);
		init();
		pack();
		this.centerOn(owner);
	...
	* @return SSHCommandControlDialog instance
	...
	private void init() 
	{
		...
		Dimension tf_dim_long = new Dimension( Globals.firstLabelWidth, Globals.buttonHeight);
		Dimension btn_dim = new Dimension( Globals.graphicButtonWidth, Globals.buttonHeight);
		...
		}
		{
			...
			cb_parentMenuText.addItem(factory.parentNull);
			...
			tf_tooltipText.setToolTipText(configed.getResourceValue("SSHConnection.CommandControl.tooltipText.tooltip"));
			...
			btn_del.setSize(new Dimension( Globals.graphicButtonWidth + 15 ,Globals.buttonHeight ));
			lbl_needSudo.setPreferredSize(tf_dim);
			cb_needSudo.setPreferredSize(btn_dim);
			tp_commands.setPreferredSize(tf_dim_long);
			// btn_changeHelpPanelStatus.setPreferredSize(new Dimension(Globals.graphicButtonWidth + 15 ,Globals.buttonHeight));
			btn_test_command.setPreferredSize(new Dimension(Globals.graphicButtonWidth + 15 ,Globals.buttonHeight));
			btn_del.setPreferredSize(new Dimension(Globals.graphicButtonWidth + 15 ,Globals.buttonHeight));
		...
		}
		{
			...
			if (!(Globals.isGlobalReadOnly()))
				((SSHCommandControlParameterMethodsPanel)parameterPanel).getButtonAdd().addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e)
					{
						((SSHCommandControlParameterMethodsPanel)parameterPanel).doActionParamAdd((JTextComponent) tp_commands);
					}
				});
		}
	...
	**/
	...
	private void initLayout()
	{
		...
		commandlistPanelLayout.setHorizontalGroup(commandlistPanelLayout.createSequentialGroup()
			...
			.addGroup(commandlistPanelLayout.createParallelGroup()
				.addGroup(commandlistPanelLayout.createSequentialGroup()
					.addComponent(lbl_commands, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
					.addGap(Globals.gapSize)
					.addComponent(btn_test_command, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
					// .addComponent(btn_changeHelpPanelStatus, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				)
		...
		commandlistPanelLayout.setVerticalGroup(commandlistPanelLayout.createSequentialGroup()	
			...
			.addGroup(commandlistPanelLayout.createParallelGroup()
				.addGroup(commandlistPanelLayout.createSequentialGroup()
					.addGap(Globals.minGapSize)
					.addComponent(lbl_commands,  GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				)
				.addGap(Globals.minGapSize)
				.addComponent(btn_test_command,  GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.minGapSize)
		...
		controlPanelLayout.setHorizontalGroup(controlPanelLayout.createSequentialGroup()
			...
			.addGroup(controlPanelLayout.createParallelGroup()
					.addComponent(lbl_tooltipText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
					.addComponent(lbl_menuText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
					.addComponent(lbl_parentMenuText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
					.addComponent(lbl_priority, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
					.addComponent(lbl_needSudo, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,GroupLayout.PREFERRED_SIZE)
			)
			.addGroup(controlPanelLayout.createParallelGroup()
				.addGroup(controlPanelLayout.createSequentialGroup()
					.addComponent(cb_menuText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
					.addGroup(controlPanelLayout.createParallelGroup()
						.addComponent(tf_priority, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(cb_needSudo, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(btn_del, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
					)
				)
				.addComponent(tf_tooltipText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
				.addComponent(cb_parentMenuText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, Short.MAX_VALUE)
			)
			.addGap(Globals.gapSize*3)	
		);
		controlPanelLayout.setVerticalGroup(controlPanelLayout.createSequentialGroup()
			...
			.addGroup(controlPanelLayout.createParallelGroup()
				.addComponent(lbl_menuText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addComponent(cb_menuText,  GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addComponent(btn_del, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
			)
					
			.addGap(Globals.minGapSize)
			.addGroup(controlPanelLayout.createParallelGroup()
				.addComponent(cb_parentMenuText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addComponent(lbl_parentMenuText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
			)
			.addGap(Globals.minGapSize)
			.addGroup(controlPanelLayout.createParallelGroup()
				.addComponent(tf_tooltipText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
				.addComponent(lbl_tooltipText, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
			)
			.addGap(Globals.minGapSize)
			.addGroup(controlPanelLayout.createParallelGroup()
	...
	/** 
	* Calls 
	* {@link de.uib.configed.gui.ssh.SSHCommandControlDialog.updateLists(requestRefresh, null) }
	**/
	...
	/**  
	* Retrieve all needed lists from factory. If refresh is requested retrieve the newest lists and setSelectedItem to selectedCommand
	...
	**/
	public void updateSelectedCommand(String menuText)
	{
		...
		if ((menuText != null) && (menuText.equals(factory.menuNew)) )	menuText = null;
		if ((menuText != null) && (menuText.length() > 0))
		{
			SSHCommand_Template thiscommand = factory.getSSHCommandByMenu(menuText);
			if (thiscommand != null )
			{
				logging.debug(this, "updateSelectedCommand menu " + thiscommand.getMenuText() + " parent " + thiscommand.getParentMenuText());
				...
				updateComponents(thiscommand.getParentMenuText(),thiscommand.getToolTipText(),thiscommand.getPriority(), thiscommand.needSudo(), combuf.toString() );
			}
		}
		else updateComponents( factory.parentNull,"",factory.position_default, false, "" );
	}
	...
	**/
	...
	public void doAction1()
	{
		...
		else JOptionPane.showInternalMessageDialog(this, configed.getResourceValue("SSHConnection.CommandControl.couldnotsave.title"),
				configed.getResourceValue("SSHConnection.CommandControl.couldnotsave"), JOptionPane.INFORMATION_MESSAGE);
	}
	...
	**/
		...
		if (! Globals.isGlobalReadOnly())
		{
			if ( cb_menuText.getSelectedItem() != null)
				if ( !((String) cb_menuText.getSelectedItem()).trim().equals(factory.menuNew) ) 
				{
					...
					if (tmp_com == null)	return;
					boolean isNotSaved = ! factory.isSSHCommandEqualSavedCommand(tmp_com);
					logging.debug(this, "checkAllTexts factory.isSSHCommandEqualSavedCommand(tmp_com) " + factory.isSSHCommandEqualSavedCommand(tmp_com));
	...
	public SSHCommand_Template getCommandNow(boolean testing)
	{
		...
		int prio = 0;
		try {prio = Integer.valueOf(tf_priority.getText());} catch (Exception e){
		...
		for (String c : tp_commands.getText().split("\n"))
			if (!((c==null) || (c.trim().equals(""))))
				coms.add(c);
		SSHCommand_Template tmp_com = factory.buildSSHCommand( 
			generateId((String)cb_menuText.getSelectedItem()),
			parent,
			menuText,
			((String) tf_tooltipText.getText()),
			prio,
			cb_needSudo.isSelected() ,
			coms
		);
