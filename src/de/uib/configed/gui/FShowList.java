...
public class FShowList extends FTextArea
{
	...
	public FShowList(JFrame owner, String title, boolean modal, Object[] buttonList)
	{
	...
	public FShowList(JFrame owner, String title, boolean modal, Object[] buttonList, int preferredWidth, int preferredHeight)
	{
		super (owner, title, modal, buttonList);
		this.owner = owner;
