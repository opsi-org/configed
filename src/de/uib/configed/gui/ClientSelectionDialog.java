...
public class ClientSelectionDialog extends FGeneralDialog
{
	...
	protected void initComponents()
	{
		...
		saveButton.setSize(new Dimension(Globals.buttonWidth, Globals.buttonHeight-2));
...
//		buttonReload.setPrefferedSize(new Dimension(Globals.buttonWidth, Globals.buttonHeight-2));
		...
		saveHGroup.addGap(Globals.vGapSize);
		saveHGroup.addComponent( buttonReload, 30, 30, 30);
		//saveHGroup.addGap(Globals.vGapSize);
	...
	private ComplexGroup createHostGroup()
	{
		...
		result.groupList.add( createSimpleGroup( new NameElement() ) );
...
/////////////////////////////////////////
	...
	private enum GroupType { HostGroup, SoftwareGroup, SwAuditGroup, HardwareGroup };
