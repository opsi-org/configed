...
{
	public static RunningInstances<FStartWakeOnLan> runningInstances 
		= new RunningInstances(
	...
	public void setPredefinedDelays(LinkedHashMap<String, Integer> labelledDelays)
	{
		...
		//comboDelay.setModel(new DefaultComboBoxModel(new Vector<String>(labelledDelays.keySet() ) ) );
	...
	protected void initComponents()
	{
		...
		JFormattedTextField textFieldHour = ((JFormattedTextField)((JSpinner.DefaultEditor) spinnerHour.getEditor()).getTextField());
		textFieldHour.setEditable(false);
		
		spinnerMinute = new JSpinner();
		JFormattedTextField textFieldMinute = ((JFormattedTextField)((JSpinner.DefaultEditor) spinnerMinute.getEditor()).getTextField());
		...
		lPanelTimeSelection.setVerticalGroup( lPanelTimeSelection.createParallelGroup(GroupLayout.Alignment.CENTER )
		                                      .addComponent(spinnerHour, de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight)
		                                      .addComponent(labelColon, de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight)
		                                      .addComponent(spinnerMinute, de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight)
		                                    );

		lPanelTimeSelection.setHorizontalGroup( lPanelTimeSelection.createSequentialGroup( )
		                                        .addComponent(spinnerHour, de.uib.configed.Globals.timeSpinnerWidth, de.uib.configed.Globals.timeSpinnerWidth, de.uib.configed.Globals.timeSpinnerWidth)
		                                        .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize)
		                                        .addComponent(labelColon, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize)
		                                        .addComponent(spinnerMinute, de.uib.configed.Globals.timeSpinnerWidth, de.uib.configed.Globals.timeSpinnerWidth, de.uib.configed.Globals.timeSpinnerWidth)
		                                      );
		...
		spinnerHour.addChangeListener(new javax.swing.event.ChangeListener()
		                              {
			                              ...
			                              {
				                              //logging.info(this, "stateChanged " + 	spinnerHour.getValue() + " " + spinnerHour.getValue().getClass().getName());
		...
		spinnerMinute.addChangeListener(new javax.swing.event.ChangeListener()
		                                {
			                                ...
			                                public void stateChanged(javax.swing.event.ChangeEvent e)
			                                {
				                                //logging.info(this, "stateChanged " + spinnerMinute.getValue() + " " + spinnerMinute.getValue().getClass().getName());
		...
		lPanelSpinnerDelay.setVerticalGroup( lPanelSpinnerDelay.createParallelGroup()
		                                     .addComponent( spinnerDelay,  de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight)
		                                   );
		lPanelSpinnerDelay.setHorizontalGroup( lPanelSpinnerDelay.createSequentialGroup()
		                                       .addComponent( spinnerDelay,  2* de.uib.configed.Globals.timeSpinnerWidth,  2* de.uib.configed.Globals.timeSpinnerWidth,  2* de.uib.configed.Globals.timeSpinnerWidth)
		                                     );
		...
		lPanel.setVerticalGroup( lPanel.createSequentialGroup()
		                         ...
		                         .addGroup( lPanel.createParallelGroup( GroupLayout.Alignment.CENTER )
		                                    .addComponent(fieldTaskname, de.uib.configed.Globals.buttonHeight,  de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight)
		                                  )
		                         .addGroup( lPanel.createParallelGroup( GroupLayout.Alignment.CENTER )
		                                    .addComponent(buttonRefreshTime, de.uib.configed.Globals.buttonHeight,  de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight)
		                                    .addComponent(buttonSetNew, de.uib.configed.Globals.buttonHeight,  de.uib.configed.Globals.buttonHeight, de.uib.configed.Globals.buttonHeight)
		                                  )
		                         .addGap(de.uib.configed.Globals.vGapSize)
		                         .addGroup( lPanel.createParallelGroup( GroupLayout.Alignment.CENTER )
		                                    .addComponent(labelDelay, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                    .addComponent(panelSpinnerDelay, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                  )
		                         .addGap(de.uib.configed.Globals.vGapSize)
		                         .addGroup( lPanel.createParallelGroup( GroupLayout.Alignment.CENTER )
		                                    .addComponent(panelTimeSelection, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                    .addComponent(labelStartdelay, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                  )
		                         .addGroup( lPanel.createParallelGroup( GroupLayout.Alignment.CENTER )
		                                    .addComponent(labelStartAt, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                    .addComponent(labelStarttime,  de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                  )
		                         .addGap(de.uib.configed.Globals.vGapSize)
		                         .addGroup( lPanel.createParallelGroup( GroupLayout.Alignment.CENTER )
		                                    .addComponent(labelClientCount, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                    .addComponent(fieldClientCount, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                    .addComponent(labelDepotCount, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                    .addComponent(fieldInvolvedDepotsCount,  de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                  )
		                         .addGap(de.uib.configed.Globals.vGapSize)

		                         .addGroup( lPanel.createParallelGroup( GroupLayout.Alignment.CENTER )
		                                    .addComponent(waitingProgressBar, de.uib.configed.Globals.progressBarHeight, de.uib.configed.Globals.progressBarHeight, de.uib.configed.Globals.progressBarHeight)
		                                    .addComponent(labelTimeYetToWait, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight, de.uib.configed.Globals.lineHeight)
		                                  )
		                       );
		...
		lPanel.setHorizontalGroup( lPanel.createParallelGroup()
		                           .addGroup( lPanel.createSequentialGroup()
		                                      .addGap(de.uib.configed.Globals.minHGapSize, de.uib.configed.Globals.hGapSize, Short.MAX_VALUE)
		                                      .addComponent(fieldTaskname, 2*de.uib.configed.Globals.buttonWidth, 3*de.uib.configed.Globals.buttonWidth, 3*de.uib.configed.Globals.buttonWidth)
		                                      .addGap(de.uib.configed.Globals.minHGapSize, de.uib.configed.Globals.hGapSize, Short.MAX_VALUE)
		                                    )
		                           .addGroup( lPanel.createSequentialGroup()
		                                      .addGap(de.uib.configed.Globals.minHGapSize, de.uib.configed.Globals.hGapSize, Short.MAX_VALUE)
		                                      .addGap(2*de.uib.configed.Globals.buttonWidth, 3*de.uib.configed.Globals.buttonWidth, 3*de.uib.configed.Globals.buttonWidth)
		                                      .addComponent(buttonSetNew, de.uib.configed.Globals.buttonWidth / 2, de.uib.configed.Globals.buttonWidth / 2, de.uib.configed.Globals.buttonWidth / 2)
		                                      .addComponent(buttonRefreshTime,  de.uib.configed.Globals.buttonWidth / 2, de.uib.configed.Globals.buttonWidth / 2, de.uib.configed.Globals.buttonWidth / 2)
		                                      .addGap(de.uib.configed.Globals.minHGapSize, de.uib.configed.Globals.hGapSize, Short.MAX_VALUE)
		                                    )
		                           .addGroup( lPanel.createSequentialGroup()
		                                      .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize)
		                                      .addComponent(panelSpinnerDelay, de.uib.configed.Globals.buttonWidth, de.uib.configed.Globals.buttonWidth, de.uib.configed.Globals.buttonWidth)
		                                      .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize)
		                                      .addComponent(labelDelay, 2 * de.uib.configed.Globals.buttonWidth, 2 * de.uib.configed.Globals.buttonWidth, 3 * de.uib.configed.Globals.buttonWidth)
		                                      .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, Short.MAX_VALUE)
		                                    )
		                           .addGroup( lPanel.createSequentialGroup()
		                                      .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize)
		                                      .addComponent(panelTimeSelection, de.uib.configed.Globals.buttonWidth, de.uib.configed.Globals.buttonWidth, de.uib.configed.Globals.buttonWidth)
		                                      .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize)
		                                      .addComponent(labelStartdelay, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		                                    )
		                           .addGroup( lPanel.createSequentialGroup()
		                                      .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize)
		                                      .addGap(de.uib.configed.Globals.buttonWidth, de.uib.configed.Globals.buttonWidth, de.uib.configed.Globals.buttonWidth)
		                                      .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize)
		                                      .addComponent(labelStartAt, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		                                      .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize)
		                                      .addComponent(labelStarttime,   1 * de.uib.configed.Globals.buttonWidth, 2 * de.uib.configed.Globals.buttonWidth, 2 * de.uib.configed.Globals.buttonWidth)
		                                      .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, Short.MAX_VALUE)
		                                    )
		                           .addGroup( lPanel.createSequentialGroup()
		                                      ...
		                                      .addGap(de.uib.configed.Globals.hGapSize)
		                                      .addComponent(labelClientCount, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		                                      .addGap(de.uib.configed.Globals.hGapSize/2)
		                                      .addComponent(fieldClientCount, clientCountWidth, clientCountWidth,  Short.MAX_VALUE)
		                                      .addGap(de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize, de.uib.configed.Globals.hGapSize)
		                                      .addComponent(labelDepotCount, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
		                                      .addGap(de.uib.configed.Globals.hGapSize/2)
		                           ...
		                           .addGroup( lPanel.createSequentialGroup()
		                                      .addGap(de.uib.configed.Globals.hGapSize)
		                                      .addComponent(waitingProgressBar, de.uib.configed.Globals.buttonWidth * 2, de.uib.configed.Globals.buttonWidth * 2, Short.MAX_VALUE)
		                                      .addGap(de.uib.configed.Globals.hGapSize)
		                                      .addComponent(labelTimeYetToWait, de.uib.configed.Globals.buttonWidth, de.uib.configed.Globals.buttonWidth , de.uib.configed.Globals.buttonWidth)
		                                      .addGap(de.uib.configed.Globals.hGapSize)
		                                    )
	...
	public void doAction1()
	{
		...
		if (waitingMillis < 0) waitingMillis = 0;
	...
	{	
		...
		if ("progress" == evt.getPropertyName()) 
		{
			...
			logging.info(this, "propertyChange  waitingProgressBar max " + waitingProgressBar.getMaximum() +  " value " + waitingProgressBar.getValue());
	...
	class WaitingTask extends SwingWorker<Void, Long> {
		...
		public Void doInBackground() {
			...
			while (elapsedMillis < waitingMillis && !stopped)
			{
				...
				//logging.info(this, " doInBackground progress elapsedMillis " + elapsedMillis);
				//logging.info(this, " doInBackground progress " + progress + " totalTimeElapsed  [min] " + elapsedMins );  
		...
		protected void process( java.util.List<Long> listOfMillis )
		{
			...
			//logging.info(this, "process :: millis " + millis);
		  	statusLabel.setText(
		  		...
		  		" " + configed .getResourceValue("FStartWakeOnLan.timeLeft") + "  " + giveTimeSpan( waitingMillis - millis ) );
		  	 ...
		  	 progressBar.setValue( ( int ) (progressBar.getMinimum() + (int) ( (barLength * millis) / waitingMillis)) ) ;  
