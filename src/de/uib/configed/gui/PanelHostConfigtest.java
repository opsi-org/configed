...
public class PanelHostConfig extends JPanel
{
	...
	protected TreeMap<String, String> propertyClasses;
		...
		for (Map.Entry<String, Object> entry : configs.entrySet())
		{
    			...
    			if (key.startsWith(de.uib.opsidatamodel.PersistenceControllerFactory.getPersistenceController().KEY_USER_ROOT + "."))
			{
				...
				if (! user.equals("{}"))
				{
					...
					if (! de.uib.opsidatamodel.PersistenceControllerFactory.getPersistenceController().PROPERTYCLASSES.containsKey(newpropertyclass))
					{
	...
	protected void buildPanel()
	{
		...
		editMapPanel = new EditMapPanelGroupedForHostConfigs(
			...
			de.uib.opsidatamodel.PersistenceControllerFactory.getPersistenceController().getPropertyClasses( ConfigedMain.target ),
