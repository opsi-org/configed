	...
	implements HostsStatusInfo
{
		...
		(Integer clientsCount, Integer selectedClientsCount, String selectedClientNames, String involvedDepots)
	{
		...
		if (selectedClientsCount != null) 
			fieldActivatedClientsCount.setText("" + selectedClientsCount);
		...
		if (selectedClientNames != null)
		{
			...
			*/
			...
			fieldSelectedClientsNames.setToolTipText("<html><body><p>"+ selectedClientNames.replace(";\n", "<br\\ >") + "</p></body></html>");
		...
		if (involvedDepots != null)
		{
			...
			fieldInvolvedDepots.setToolTipText("<html><body><p>"+ involvedDepots.replace(";\n", "<br\\ >") + "</p></body></html>");
		}	
	}
	
	
	public void setActivatedClientsCount(int n)
	{
		fieldActivatedClientsCount.setText("" + n);
	}
	...
	private void createGui()
	{
		...
		//JScrollPane viewSelectedClientsNames = new JScrollPane(fieldSelectedClientsNames);
		...
		layoutStatusPane.setHorizontalGroup(
			layoutStatusPane.createSequentialGroup()
				...
				.addGap(Globals.hGapSize/2, Globals.hGapSize/2, Globals.hGapSize)
				.addComponent(fieldGroupActivated, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,  Short.MAX_VALUE)
				.addGap(Globals.hGapSize/2, Globals.hGapSize/2, Globals.hGapSize)
				...
				.addComponent(fieldSelectedClientsNames, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,  Short.MAX_VALUE)
				.addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
				.addComponent(labelSelectedClientsCount, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize/2, Globals.hGapSize/2, Globals.hGapSize)
				.addComponent(fieldActivatedClientsCount, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE)
				.addGap(Globals.hGapSize, Globals.hGapSize, Globals.hGapSize)
				.addComponent(labelInvolvedDepots, 2, GroupLayout.PREFERRED_SIZE,  GroupLayout.PREFERRED_SIZE)
				.addComponent(fieldInvolvedDepots, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE,  Short.MAX_VALUE)
			...
			layoutStatusPane.createParallelGroup(GroupLayout.Alignment.CENTER)
				.addGroup(layoutStatusPane.createSequentialGroup()
					...
					.addGroup(layoutStatusPane.createParallelGroup(GroupLayout.Alignment.BASELINE)
						.addComponent(labelAllClientsCount, Globals.lineHeight, Globals.lineHeight,  Globals.lineHeight)
						.addComponent(labelActivated, Globals.lineHeight, Globals.lineHeight,  Globals.lineHeight)
						.addComponent(labelGroupActivated, Globals.lineHeight, Globals.lineHeight,  Globals.lineHeight)
						.addComponent(fieldGroupActivated, Globals.lineHeight, Globals.lineHeight,  Globals.lineHeight)
						.addComponent(labelSelectedClientsCount, Globals.lineHeight, Globals.lineHeight,  Globals.lineHeight)
						.addComponent(fieldActivatedClientsCount,  Globals.lineHeight,  Globals.lineHeight,  Globals.lineHeight)
						.addComponent(labelSelectedClientsNames, Globals.lineHeight, Globals.lineHeight,  Globals.lineHeight)
						.addComponent(fieldSelectedClientsNames, Globals.lineHeight, Globals.lineHeight,  Globals.lineHeight)
						.addComponent(labelInvolvedDepots, Globals.lineHeight, Globals.lineHeight,  Globals.lineHeight)
						.addComponent(labelInvolvedDepots2, Globals.lineHeight, Globals.lineHeight,  Globals.lineHeight)
						.addComponent(fieldInvolvedDepots, Globals.lineHeight, Globals.lineHeight,  Globals.lineHeight)
					)
					.addGap(Globals.vGapSize/2, Globals.vGapSize/2, Globals.vGapSize/2)
				)
			)
		...
		csStatusPane.doForAllContainedCompisOfClass 
		 ("setBackground", new Object[]{Globals.backLightBlue}, javax.swing.JLabel.class);
		 */
		csStatusPane.doForAllContainedCompisOfClass 
