...
public class Globals 
{
	...
	public static final String opsiDocpage = "http://www.opsi.org/en/documentation-info";
	public static final String opsiSupportpage = "http://opsi.org/en/support";
	public static final String opsiForumpage = "https://forum.opsi.org";
	...
	*/
	...
	public static final String[] logtypes = new String[]{"clientconnect","instlog","userlogin","bootimage","opsiconfd"};
	public static final int[] maxLogSizes = new int[]{4*1024*1024, 8*1024*1024, 8*1024*1024, 0, 1* 1024*1024};
	...
	public static boolean forbidEditingTargetSpecific()
	{
		...
		de.uib.utilities.logging.logging.info("forbidEditing for target " +  ConfigedMain.getEditingTarget() + "?");
		...
		de.uib.utilities.logging.logging.info("forbidEditing " + forbidEditing);
