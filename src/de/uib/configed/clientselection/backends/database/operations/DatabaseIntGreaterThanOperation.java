...
public class DatabaseIntGreaterThanOperation extends IntGreaterThanOperation
{
    private int compareInteger;
    private String elementName;
    private String table;
    
    public DatabaseIntGreaterThanOperation( String elementName, int compareInteger, String table )
    {
