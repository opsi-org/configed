...
public class DatabaseIntLessThanOperation extends IntLessThanOperation
{
    private int compareInteger;
    private String elementName;
    private String table;
    
    public DatabaseIntLessThanOperation( String elementName, int compareInteger, String table )
    {
